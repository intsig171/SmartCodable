...
| ⑥ **json字符串的Model化** | 字段对应的是json字符串，支持进行Model化解析                  | ✅            | ✅         |
| ⑦ **枚举的解析**          | 当枚举解析失败时，支持兼容。                                 | ✅            | ✅         |
...
| 💡 建议列表                    | 是否采纳 | 理由                                                         |
| ----------------------------- | -------- | ------------------------------------------------------------ |
| ① **便捷的Model的继承解析**   | ❌        | [不采纳的理由](https://github.com/intsig171/SmartCodable/blob/main/Document/建议/%23suggest%201%20在mapping方法中支持解析忽略.md) |
| ② **Model内支持忽略解析属性** | ❌        |                                                              |
